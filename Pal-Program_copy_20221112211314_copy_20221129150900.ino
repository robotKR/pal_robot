...
void setup() {
  ...
  xTaskCreatePinnedToCore(Core1a, "Core1a", 8192, NULL, 3, &thp[2], 1);
  xTaskCreatePinnedToCore(Core1b, "Core1b", 8192, NULL, 4, &thp[3], 1);
...
void Core1b(void *args){
  while(1){
    ...
    /*display.clearDisplay();
    display.drawBitmap(44,0,eyes3, BMP_WIDTH, BMP_HEIGHT, 1);
    display.display();
